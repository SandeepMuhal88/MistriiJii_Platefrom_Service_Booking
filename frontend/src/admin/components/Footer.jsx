                    ...
                    <div className="footer-grid">
                        ...
                        <div className="footer-brand">
                            ...
                            <div className="footer-socials">
                                {/* Instagram Button */}
                                <a
                                    href="https://www.instagram.com/mistrijii"
                                    target="_blank"
                                    rel="noreferrer"
                                    className="flex items-center justify-center w-10 h-10 rounded-full text-white bg-gradient-to-tr from-[#f9ce34] via-[#ee2a7b] to-[#6228d7] transition-transform hover:scale-110"
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    rel="noreferrer"
                                    className="flex items-center justify-center w-10 h-10 rounded-full text-white bg-[#25D366] transition-transform hover:scale-110 shadow-md"
                                    aria-label="WhatsApp"
                                >
                                    <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
